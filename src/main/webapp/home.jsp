...
<body class="bg-fixed text-center bg-gradient-to-b from-blue-100 to-yellow-100">
    <h1 class="text-2xl font-semibold mt-8">Group Project 1</h1>
    <h2 class="text-xl font-medium">Prepared by Alisa Vynohradova and Andrii Denysenko</h2>
    <br/>
